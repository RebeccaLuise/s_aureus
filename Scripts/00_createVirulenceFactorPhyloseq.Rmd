...
```{r}
ps_all_clean <- readRDS("/Users/rebecca/Documents/Forschung/S_aureus_letter/r_analysis_s_aureus/s_aureus/mOTU_catalogue_totalReadcount_20251211.rds")
...
write_rds(ps, "vfdb_phyloseq_20251211.rds")
```
